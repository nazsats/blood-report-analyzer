      ...
      >
        ...
        <div className="space-y-6">
          ...
          <motion.button
            ...
            disabled={loading}
            className={`w-full py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl font-semibold text-lg flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-md ${
